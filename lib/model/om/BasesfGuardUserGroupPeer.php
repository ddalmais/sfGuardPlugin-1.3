...
abstract class BasesfGuardUserGroupPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (sfGuardUserGroupPeer::GROUP_ID, sfGuardUserGroupPeer::USER_ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (sfGuardUserGroupPeer::GROUP_ID => 0, sfGuardUserGroupPeer::USER_ID => 1, ),
	...
	const COUNT = 'COUNT(sf_guard_user_group.GROUP_ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT sf_guard_user_group.GROUP_ID)';
    ...
    foreach (sfMixer::getCallables('BasesfGuardUserGroupPeer:doSelectRS:doSelectRS') as $callable)
    {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(sfGuardUserGroupPeer::GROUP_ID, $vals[0], Criteria::IN);
			$criteria->add(sfGuardUserGroupPeer::USER_ID, $vals[1], Criteria::IN);
		}
	...
	public static function retrieveByPK( $group_id, $user_id, $con = null) {
		if ($con === null) {
			$con = Propel::getConnection(self::DATABASE_NAME);
		}
